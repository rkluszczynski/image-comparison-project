...
@Component(value = "statisticsRunner")
public class StatisticsCalculatorRunner {
    private static final Logger logger = LoggerFactory.getLogger(StatisticsCalculatorRunner.class);
